...
module.exports = function (auth, baseUrl, opts) {
  ...
  return {
    ...
    connect: {
      ...
      isPayoutsEnabled: function (customerId) {
        return request({
          url: `${urlJoin(url, customerId, "payouts-enabled")}`,
          method: "GET",
          auth,
        });
      },
    ...
    adspaces: {
      ...
      addTags: function (customerId, adspaceId, tags) {
        return request({
          url: urlJoin(url, customerId, "adspaces", adspaceId, "tags"),
          method: "PUT",
          json: true,
          auth,
          body: tags,
      ...
      removeTags: function (customerId, adspaceId, tags) {
        return request({
          url: urlJoin(url, customerId, "adspaces", adspaceId, "tags"),
          method: "DELETE",
          json: true,
